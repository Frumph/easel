					...
					<tr class="alternate">
						<th scope="row">
							<label for="disable_post_titles">
								<?php _e( 'Disable the titles on posts?', 'easel' ); ?>
							</label>
						</th>
						<td>
					...
					<tr>
						<th scope="row">
							<label for="enable_post_calendar">
								<?php _e( 'Add graphic calendar to blog posts?', 'easel' ); ?>
							</label>
						</th>
						<td>
					...
					<tr class="alternate">
						<th scope="row">
							<label for="enable_post_author_gravatar">
								<?php _e( 'Enable Author Gravatar?', 'easel' ); ?>
							</label>
						</th>
						<td>
					...
					<tr>
						<th scope="row">
							<label for="enable_avatar_trick">
								<?php _e( 'Enable Avatar Mod?', 'easel' ); ?>
							</label>
						</th>
						<td>
					...
					<tr class="alternate">
						<th scope="row">
							<label for="disable_tags_in_posts">
								<?php _e( 'Disable display of <strong>tags</strong> in posts?', 'easel' ); ?>
							</label>
						</th>
						<td>
					...
					<tr>
						<th scope="row">
							<label for="disable_categories_in_posts">
								<?php _e( 'Disable display of <strong>categories</strong> in posts?', 'easel' ); ?>
							</label>
						</th>
						<td>
					...
					<tr class="alternate">
						<th scope="row">
							<label for="disable_author_info_in_posts">
								<?php _e( 'Disable display of <strong>by Author</strong> in post information?', 'easel' ); ?>
							</label>
						</th>
						<td>
					...
					<tr>
						<th scope="row">
							<label for="disable_date_info_in_posts">
								<?php _e( 'Disable display of the posted on date in posts?', 'easel' ); ?>
							</label>
						</th>
						<td>
					...
					<tr class="alternate">
						<th scope="row">
							<label for="disable_posted_at_time_in_posts">
								<?php _e( 'Disable the display of the posted at time in posts?', 'easel' ); ?>
							</label>
						</th>
						<td>
					...
					<tr>
						<th scope="row">
							<label for="enable_last_modified_in_posts">
								<?php _e( 'Enable the display of last modified information in posts?', 'easel' ); ?>
							</label>
						</th>
						<td>
					...
					<tr class="alternate">
						<th scope="row">
							<label for="disable_page_titles">
								<?php _e( 'Disable the titles on pages?', 'easel' ); ?>
							</label>
						</th>
						<td>
					...
					<tr>
						...
						<th scope="row">
							<label for="content_width">
								<?php _e( 'Media and images width on posts and pages?', 'easel' ); ?>
							</label>
						</th>
						<td>
					...
					<tr class="alternate">
						...
						<th scope="row">
							<label for="content_width_disabled_sidebars">
								<?php _e( 'Media and images width when sidebars are disabled on pages?', 'easel' ); ?>
							</label>
						</th>
						<td>
