...
// if (easel_themeinfo('facebook_meta')) add_action('wp_head', 'easel_add_facebook_meta');
...
// if (easel_themeinfo('facebook_like_blog_post')) add_action('the_content', 'easel_display_facebook_like');
