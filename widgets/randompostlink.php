...
class easel_random_post_link_widget extends WP_Widget {
	...
	function __construct() {
		parent::__construct(
			__CLASS__, // Base ID
			__( 'Easel - Random Post Link', 'easel' ), // Name
			array( 'classname' => __CLASS__, 'description' => __( 'Displays a link to click that triggers going to a random blog post.', 'easel' ), ) // Args
		);
	}
