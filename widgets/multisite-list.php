	...
	if (is_multisite()) {
		...
		class widget_multisite_sitelist extends WP_Widget {
			...
			function __construct() {
				parent::__construct(
					__CLASS__, // Base ID
					__( 'Easel - Site List', 'easel' ), // Name
					array( 'classname' => __CLASS__, 'description' => __( 'Display Site List of all sites that have recently updated on this Multisite.', 'easel' ), ) // Args
				);
			}
