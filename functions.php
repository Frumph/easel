 ...
 */
function easel_register_required_plugins() {
...
if (is_admin()) {
	@require_once(easel_themeinfo('themepath').'/lib/class-tgm-plugin-activation.php');
